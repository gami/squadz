...
class _$_Counter with DiagnosticableTreeMixin implements _Counter {
  const _$_Counter({this.current = 0});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Counter(current: $current)';
  }
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(current);
...
abstract class _Counter implements Counter {
  const factory _Counter({int current}) = _$_Counter;
